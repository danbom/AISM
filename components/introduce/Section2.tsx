      ...
      <div className="container">
        <div>
          ...
          <div>
            <div className="feature">
              <div className="text">
                ...
                <p>
                  ...
                  기능에 대한 전반적인 내용과 기초의학의 기반을 닦아주고
                  신체모델을 통해 기능적 움직임을 실습하는 해부학 강의에서 특허
                  받은 해부학 교구를 사용합니다.
                </p>
              </div>
            ...
            <div className="feature">
              <div className="text">
                <span className="highlight">미국 체형 분석 전문가들</span>의
                선진 교육
                <p>
                  AISM은 미국의 물리치료사 및 헬스 트레이너들과 교류하며 선진
                  교육 프로그램 개발에 힘쓰고 있습니다. 이번에 열리는 체형 분석
                  전문가 과정은 한국은 물론 미국의 유능한 강사진들로 구성되어
                  알차고 뜻깊은 과정이 될 것입니다.
                </p>
              </div>
            ...
            <div className="feature">
              <div className="text">
                ...
                <p>
                  2013년 학회 초기에는 물리치료사들의 도수 치료 기법에 대한
                  강의가 주를 이루었으나, 2016년 이후 물리치료사 및 헬스
                  트레이너, 건강 관련 종사자들에게도 교육을 하고 있습니다.
                </p>
              </div>
